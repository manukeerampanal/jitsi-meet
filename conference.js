...
export default {
    ...
    createInitialLocalTracksAndConnect(roomName, startScreenSharing) {
        ...
        .then(([tracks, con]) => {
            ...
            // screensharing dialog, but it's still better than in the reverse
            // order where the screensharing dialog will sometime be closing
            // the microphone alert ($.prompt.close(); is called). Need to
            // figure out dialogs chaining to fix that.
