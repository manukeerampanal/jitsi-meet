...
/**
 * Shows a dialog which as user to install the extension. This one is displayed
 * after installation is triggered from the script, but fails because it must be
 * initiated by user gesture.
